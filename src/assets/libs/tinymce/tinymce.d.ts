...
declare type NormalizedEvent<E, T = unknown> = E & {
...
declare type SimpleProcessor = (value: any) => boolean;
declare type Processor<T> = (value: any) => ProcessorSuccess<T> | ProcessorError;
