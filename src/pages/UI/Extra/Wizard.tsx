      ...
      <div className="container container-tight py-4">
        ...
        <div className="card card-md">
          <div className="card-body text-center py-4 p-sm-5">
            <img src="./static/illustrations/undraw_sign_in_e6hj.svg" height={120} className="mb-n2" alt="" />
          ...
          <div className="card-body">
            <div className="mb-3">
              ...
              <div className="form-hint">
                Choose a URL that describes you or your business in a concise way. Make it short and easy to remember so
                you can share links with ease.
              </div>
            </div>
            <div>
        ...
        <div className="row align-items-center mt-3">
          ...
          <div className="col">
            <div className="btn-list justify-content-end">
              <a href="#" className="btn btn-link link-secondary">
                Set up later
              </a>
