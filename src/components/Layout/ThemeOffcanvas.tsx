...
import { setColor, setLanguageMode, setPosition, setSettingMenuShow, setTheme, setType, setVerticalLocation, setWidth } from "~/store/theme";
...
const ThemeOffcanvas = () => {
  ...
  const { color, languageMode, position, theme, type, width, verticalLocation, settingMenuShow } = appSelector((state: RootState) => state.theme);
  ...
  return (
    <Offcanvas id="themeOffcanvas" show={settingMenuShow} scroll placement="end" onHide={() => dispatch(setSettingMenuShow(false))}>
